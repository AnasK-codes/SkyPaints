        ...
        <section className="px-4 md:px-8 lg:px-24 max-w-[1600px] mx-auto animate-fade-in-up">
          <div className="mb-12">
            ...
            <p className="font-body text-on-surface-variant text-lg">
              Review your selected products and request a personalized
              quotation.
            </p>
          </div>
          ...
          {items.length === 0 ? (
            <div className="bg-surface-container-low rounded-[2rem] p-12 text-center border border-outline-variant/10 shadow-sm">
              <Icon
                name="shopping_cart"
                className="text-6xl text-primary/30 mb-4 block"
              />
              ...
              <Link
                href="/products"
                className="bg-primary text-on-primary px-8 py-4 rounded-full font-label font-bold shadow-ambient hover:shadow-ambient-hover transition-all"
              >
                Explore Products
              </Link>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
                ...
                <div className="bg-surface-container-lowest rounded-[2rem] p-4 md:p-8 border border-outline-variant/10 shadow-sm">
                  ...
                  <div className="space-y-6">
                    {items.map((item) => (
                      <div
                        key={item.id}
                        className="flex flex-col sm:flex-row gap-4 items-center sm:items-start p-4 rounded-2xl bg-surface-container-low/50 hover:bg-surface-container-low transition-colors border border-outline-variant/5"
                      >
                        ...
                        <div className="flex-grow text-center sm:text-left flex flex-col justify-between h-full w-full">
                          <div>
                            <h3 className="font-headline text-lg text-on-surface leading-tight mb-1">
                              {item.name}
                            </h3>
              ...
              <div className="lg:col-span-5">
                <div className="bg-surface-container-lowest rounded-[2rem] p-6 md:p-8 border border-outline-variant/10 shadow-ambient sticky top-32">
                  <h2 className="font-headline text-2xl text-primary mb-6">
                    Request Quotation
                  </h2>
