        ...
        <div className="prose prose-on-surface dark:prose-invert max-w-none">
          ...
          <section className="mb-10">
            ...
            <p className="text-on-surface-variant mb-4">
              At Skypaints, we collect information you provide directly to us,
              such as when you create an account, subscribe to our newsletter,
          ...
          <section className="mb-10">
            ...
            <p className="text-on-surface-variant mb-4">
              ...
              improve our services, communicate with you, and send you technical
              notices, updates, and administrative messages.
            </p>
          </section>
          ...
          <section className="mb-10">
            ...
            <p className="text-on-surface-variant mb-4">
              ...
              parties for their direct marketing purposes. We may share your
